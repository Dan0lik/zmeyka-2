...
(function snakeGame() {
    ...
    // document.querySelector('.best_Score_Number').innerText
   
    let name = prompt("Ваше имя", "");
    document.getElementById("name_player").innerHTML = name;

        var score_finish = Number.parseInt(document.querySelector('.best_Score_Number').innerText);

        var auction_id1 = document.getElementById('OnePlayer_id').innerHTML;
        var auction1 = Number.parseInt(auction_id1);
       

        var auction_id2 = document.getElementById('TwoPlayer').innerHTML;
        var auction2 = Number.parseInt(auction_id2);

        var auction_id3 = document.getElementById('ThreePlayer').innerHTML;
        var auction3 = Number.parseInt(auction_id3);

    let tabll = ["...", "...", "..."];

    if(document.querySelector('.best_Score_Number').innerText <  document.querySelector('.score_Number').innerText){
        
        if(score_finish < auction1){
            document.getElementById("name_1").innerHTML =name ;
            document.getElementById("OnePlayer_id").innerHTML = auction1;
            localStorage.setItem("OnePlayer", oneplayer);
            localStorage.setItem("name_1", oneplayer);
        }
    ...
    document.getElementById("TwoPlayer").innerHTML = auction1;
     document.getElementById("ThreePlayer").innerHTML = score_finish;
